var quiz = webpackJsonp_name_([ 8 ], [ function(t, e, n) {
"use strict";
function r() {
...
i.start(), n.e(6, function() {
i.stop();
var t = n(42).AuthModal;
new t({
callback: r
});
});
...
var o = n(37), s = n(28), u = (n(38), n(36)), c = n(23);
e.init = r;
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, e, n) {
"use strict";
function r(t) {
...
var o = new XMLHttpRequest(), s = t.method || "GET", u = t.body, c = t.url;
o.open(s, c, t.sync ? !1 : !0), o.method = s;
var l = a();
l && !t.skipCsrf && o.setRequestHeader("X-XSRF-TOKEN", l), "[object Object]" == {}.toString.call(u) && (o.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), 
u = JSON.stringify(u)), o.addEventListener("loadstart", function(t) {
o.timeStart = Date.now(), e(t.type);
var r = n("xhrstart", t);
...
if (!o.status) return void r("Не получен ответ от сервера.", e);
if (-1 == f.indexOf(o.status)) return void r("Ошибка на стороне сервера (код " + o.status + "), попытайтесь позднее", e);
var n = o.responseText, a = o.getResponseHeader("Content-Type");
...
function r(t) {
function e() {
var t = m[0].contentWindow;
return "function" != typeof t.postMessage ? void alert("Извините, запуск кода требует более современный браузер") : void t.postMessage(p, "//ru.lookatcode.com/showjs");
}
function n() {
var e;
if (g && t.dataset.refresh && (g.remove(), g = null), g || (g = t.querySelector(".code-result")), 
...
"0" === t.dataset.demoHeight) e.style.display = "none"; else if (t.dataset.demoHeight) {
var n = +t.dataset.demoHeight;
e.style.height = n + "px";
}
...
r.open(), r.write(l(p)), r.close(), void 0 === t.dataset.demoHeight && o.iframe(e), 
b && void 0 !== t.dataset.autorun || s(g) || g.scrollIntoView(!1);
} else {
var i = document.createElement("form");
i.style.display = "none", i.method = "POST", i.enctype = "multipart/form-data", 
i.action = "//ru.lookatcode.com/showhtml", i.target = e.name;
var a = document.createElement("textarea");
a.name = "code", a.value = l(p), i.appendChild(a), e.parentNode.insertBefore(i, e.nextSibling), 
i.submit(), i.remove(), b && void 0 !== t.dataset.autorun || (e.onload = function() {
void 0 === t.dataset.demoHeight && o.iframe(e), s(g) || g.scrollIntoView(!1);
});
}
}
function r() {
...
} else t.dataset.refresh && m && (m.remove(), m = null), m ? e() : (m = document.createElement("iframe"), 
...
Prism.highlightElement(h), u(d), i(d, t.dataset.highlightBlock), a(d, t.dataset.highlightInline);
var m, g, v = d.classList.contains("language-javascript"), $ = d.classList.contains("language-markup"), y = t.dataset.trusted, b = !0;
if (v || $) {
...
}), void 0 !== t.dataset.autorun && ("epub" == window.ebookFormat && "no-epub" == t.dataset.autorun ? t.querySelector("iframe").remove() : setTimeout(f, 1e3));
}
}
function i(t, e) {
...
var o = n(18), s = n(80), u = n(79);
t.exports = r;
}, function(t, e, n) {
"use strict";
function r(t) {
window.isEbook || (this.elem = t, this.translateX = 0, this.switchesElem = t.querySelector("[data-code-tabs-switches]"), 
...
if (g) {
f && (d = g[1].length);
var v = g.index - 1 + d, g = g[0].slice(d), $ = g.length, y = v + $, b = m.slice(0, v + 1), w = m.slice(y + 1), E = [ p, 1 ];
b && E.push(b);
var _ = new r(o, l ? n.tokenize(g, l) : g, h);
E.push(_), w && E.push(w), Array.prototype.splice.apply(i, E);
}
}
}
}
...
//# sourceMappingURL=quiz.a20337eb47c2fcdeeb80.js.map