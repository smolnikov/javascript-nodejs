...
S && w.push(S);
var y = new i(o, d ? t.tokenize(E, d) : E, h);
...
a.open(), a.write(u(h)), a.close(), "epub" == window.ebookType && setTimeout(function() {
[].forEach.call(a.querySelectorAll("script"), function(e) {
e.remove();
});
}, 2e3), e.hasAttribute("data-demo-height") || s.iframe(t), S && e.hasAttribute("data-autorun") || o(A) || A.scrollIntoView(!1);
} else {
...
r.name = "code", r.value = u(h), i.appendChild(r), t.parentNode.insertBefore(i, t.nextSibling), 
...
function u() {
var e = h.toLowerCase(), t = e.match("<body>"), n = e.match("</body>"), a = e.match("<html>"), i = e.match("</html>"), r = e.match(/^\s*<!doctype/);
if (r) return h;
var s = h;
...
var p = e.querySelector("pre"), m = p.querySelector("code"), h = m.textContent;
Prism.highlightElement(m), l(p), i(p, e.getAttribute("data-highlight-block")), r(p, e.getAttribute("data-highlight-inline"));
...
//# sourceMappingURL=quiz.718527394608b9fb1793.js.map