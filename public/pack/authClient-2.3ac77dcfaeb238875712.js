...
var b = r[p];
b.match(RegExp("^(?!" + t.element + ")" + t.modifier)) ? r[p] = f + b : b.match(RegExp("^" + t.element)) && (s[s.length - 2] ? r[p] = s[s.length - 2] + b : r[p] = s[s.length - 1] + b), 
...
//# sourceMappingURL=authClient-2.3ac77dcfaeb238875712.js.map