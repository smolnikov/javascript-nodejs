...
}(), a = o(34), r = o(23), l = o(40), s = o(33), p = function() {
function e(t) {
var o = this;
...
product: "ebook"
}), new r.Error("Введите email."), void this.elem.elements.email.focus();
...
if (403 == this.status) return new r.Error("<p>" + (e.result.description || e.result.message) + "</p><p>Пожалуйста, начните оформление заново.</p><p>Если вы считаете, что на сервере ошибка &mdash; свяжитесь со <a href='mailto:orders@javascript.ru'>службой поддержки</a>.</p>"), 
void n();
var o = e.result;
if (o.form) {
...
a.called || (a.called = !0, i.firstChild.submit());
});
window.ga("send", "event", "payment", "purchase", "ebook", {
hitCallback: a
}), setTimeout(a, 500), window.metrika.reachGoal("PURCHASE", {
product: "ebook",
method: t.paymentMethod,
price: t.amount,
number: o.orderNumber
});
} else n(), new r.Error("Ошибка на сервере, свяжитесь со <a href='mailto:orders@javascript.ru'>службой поддержки</a>.");
...
//# sourceMappingURL=ebook.e60c6f1d8eef675f4b63.js.map