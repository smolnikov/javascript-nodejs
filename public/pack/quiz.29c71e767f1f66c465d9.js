...
if (_) {
p && (d = _[1].length);
var g = _.index - 1 + d, _ = _[0].slice(d), b = _.length, v = g + b, x = m.slice(0, g + 1), y = m.slice(v + 1), w = [ h, 1 ];
x && w.push(x);
var $ = new i(a, u ? n.tokenize(_, u) : _, f);
...
function n() {
var t;
if (_ && e.hasAttribute("data-refresh") && (_.remove(), _ = null), _ || (_ = e.querySelector(".code-result")), 
_) t = _.querySelector("iframe"); else {
if (_ = document.createElement("div"), _.className = "code-result code-example__result", 
...
_.appendChild(t), e.appendChild(_);
}
if (v) {
...
}, 2e3), e.hasAttribute("data-demo-height") || a.iframe(t), x && e.hasAttribute("data-autorun") || s(_) || _.scrollIntoView(!1);
} else {
...
e.hasAttribute("data-demo-height") || a.iframe(t), s(_) || _.scrollIntoView(!1);
});
}
}
function i() {
...
var m, _, g = d.classList.contains("language-javascript"), b = d.classList.contains("language-markup"), v = +e.getAttribute("data-trusted"), x = !0;
if (g || b) {
...
//# sourceMappingURL=quiz.29c71e767f1f66c465d9.js.map