...
/***/ function(module, exports, __webpack_require__) {
	...
	jade_mixins["e"].call({
	block: function(){
	buf.push("Время от времени проходит онлайн-курс по Node.JS / IO.JS.");
	},
	attributes: {"class": "text"}
	}, "p");
	jade_mixins["e"].call({
	block: function(){
	buf.push("Курс &mdash; это практическая разработка, обсуждение грамотных решений самых разных задач с разработчиком, который использует Node, начиная с версий 0.1.");
	}
	}, "p");
	jade_mixins["e"].call({
	block: function(){
	buf.push("Пришлю уведомление, когда будет открыта запись. Также уведомление будет при новых выпусках скринкаста.");
	}
	}, "p");
	jade_mixins["e"].call({
	block: function(){
...
//# sourceMappingURL=nodejsScreencast.70003865371518b4488f.js.map