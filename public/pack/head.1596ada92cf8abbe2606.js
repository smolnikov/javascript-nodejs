...
"12": "about",
"13": "quiz"
}[t] || t) + "-" + t + ".1596ada92cf8abbe2606.js", r.appendChild(o);
}
...
!window.localStorage, n(7), e.login = n(8), n(9), e.Modal = n(10), e.fontTest = n(11), 
e.resizeOnload = n(18), n(12), n(13), n(14), n(15), n(16), n(17), n(23).init();
},
7: function() {
"use strict";
...
function e(t, e) {
e = e || {};
var n, r, i, o, a, s = e.onRight || function() {}, u = e.onLeft || function() {}, c = e.tolerance || 50, l = e.threshold || 150, f = e.allowedTime || 500;
t.addEventListener("touchstart", function(t) {
var e = t.changedTouches[0];
i = 0, n = e.pageX, r = e.pageY, a = Date.now();
}), t.addEventListener("touchend", function(t) {
var e = t.changedTouches[0];
i = e.pageX - n, o = Date.now() - a, Math.abs(e.pageY - r) > c || o > f || (i > l && s(t), 
-l > i && u(t));
});
}
t.exports = e;
...
enumerable: !0,
get: function() {
var t, e, n, r, i, o, a = this, s = this.attributes, u = s.length, c = function(t) {
...
for (t = 0; u > t; t++) if (o = s[t], o && o.name && /^data-\w[\w\-]*$/.test(o.name)) {
...
//# sourceMappingURL=head.1596ada92cf8abbe2606.js.map