...
/***/ function(module, exports, __webpack_require__) {
	...
	var TutorialMapModal = __webpack_require__(129);
	...
	exports.init = function () {
	  ...
	  if (window.ebookType) {
	    __webpack_require__.e/* nsure */(13, function () {
	      __webpack_require__(131).init();
	    });
	  }
	};
	
	exports.TutorialMap = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TutorialMap = __webpack_require__(130);
	...
	function TutorialMapModal() {
	  ...
	  request.addEventListener('success', function (event) {
	    ...
	    _this.elem = document.body.lastChild;
	    _this.elem.innerHTML = event.result + '<button class="close-button tutorial-map-overlay__close"></button>';
	
	    _this.elem.addEventListener('click', function (e) {
	    ...
	    _this.elem.addEventListener('scroll', trackSticky);
	
	    new TutorialMap(_this.elem.firstElementChild);
	  });
...
//# sourceMappingURL=tutorial.70003865371518b4488f.js.map