...
a ? r[0] = s[s.length - 1] + t.element + r[0] : s[s.length] = c;
...
var o = t.class, l = e.class;
(o || l) && (o = o || [], l = l || [], Array.isArray(o) || (o = [ o ]), Array.isArray(l) || (l = [ l ]), 
t.class = o.concat(l).filter(s));
for (var r in e) "class" != r && (t[r] = e[r]);
return t;
...
var l = a[o], r = t[l];
"class" == l ? (r = i(r)) && s.push(" " + l + '="' + r + '"') : s.push(e.attr(l, r, !1, n));
}
return s.join("");
}, e.escape = function(t) {
...
var l = 3, r = i.split("\n"), c = Math.max(s - l, 0), u = Math.min(r.length, s + l), l = r.slice(c, u).map(function(t, e) {
var n = e + c + 1;
return (n == s ? "  > " : "    ") + n + "| " + t;
}).join("\n");
...
attributes: {
"data-form": "login",
"class": (e = [ !0 ], s.joinClasses([ [ "login-form", a ? "_modal" : "_inline" ] ].map(s.joinClasses).map(function(t, n) {
...
block: function() {
n.push('Регистрируясь, вы принимаете <a href="/agreement">пользовательское соглашение</a>.');
},
attributes: {
...
}(), a = n(28), o = n(27), l = n(53), r = n(113), c = n(114), u = n(115), f = n(49), p = function() {
function t(e) {
...
if (201 == this.status) return i.elem.innerHTML = f(r, this.options), void i.showFormMessage({
...
s.addEventListener("success", function(t) {
200 == this.status ? (i.elem.innerHTML = f(r, this.options), i.showFormMessage({
html: t.result,
type: "success"
...
//# sourceMappingURL=authClient-2.8c1fc9516d3eb8c72269.js.map