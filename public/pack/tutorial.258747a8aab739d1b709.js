...
if (n--, n >= 0) {
var i = e[n].firstElementChild && e[n].firstElementChild.getAttribute("href"), a = document.querySelector('.sidebar__navigation-link a[href="' + i + '"]');
...
var o = r[a], s = o.querySelectorAll(".tutorial-map__sub-item"), u = Array.prototype.reduce.call(s, function(t, r) {
var i = !1;
if (n) {
var a = r.querySelectorAll(".tutorial-map__sub-sub-item");
i = Array.prototype.reduce.call(a, function(t, n) {
var r = e(n);
return n.hidden = !r, t || r;
}, !1);
}
var o = i || e(r);
return r.hidden = !o, t || o;
}, !1);
o.hidden = !(u || e(o));
}
...
}, 2e3), t.hasAttribute("data-demo-height") || o.iframe(e), b && t.hasAttribute("data-autorun") || s(g) || g.scrollIntoView(!1);
} else {
...
a.name = "code", a.value = c(d), i.appendChild(a), e.parentNode.insertBefore(i, e.nextSibling), 
...
function c() {
var t = d.toLowerCase(), e = t.match("<body>"), n = t.match("</body>"), r = t.match("<html>"), i = t.match("</html>"), a = t.match(/^\s*<!doctype/);
if (a) return d;
var o = d;
...
Prism.highlightElement(p), u(h), i(h, t.getAttribute("data-highlight-block")), a(h, t.getAttribute("data-highlight-inline"));
var m, g, v = h.classList.contains("language-javascript"), $ = h.classList.contains("language-markup"), y = +t.getAttribute("data-trusted"), b = !0;
if (v || $) {
...
var i = e[r].split(":"), a = +i[0], o = i[1].split("-"), s = +o[0], u = +o[1], l = '<code class="inline-highlight">' + Array(a + 1).join("\n") + Array(s + 1).join(" ") + '<code class="mask">' + Array(u - s + 1).join(" ") + "</code></code>";
...
c.highlightedCode = r.stringify(JSON.parse(t.data), o), n.hooks.run("before-insert", c), 
c.element.innerHTML = c.highlightedCode, a && a.call(c.element), n.hooks.run("after-highlight", c);
}, f.postMessage(JSON.stringify({
language: c.language,
code: c.code
}));
} else c.highlightedCode = n.highlight(c.code, c.grammar, c.language), n.hooks.run("before-insert", c), 
c.element.innerHTML = c.highlightedCode, a && a.call(e), n.hooks.run("after-highlight", c);
}
}
},
...
if (g) {
f && (h = g[1].length);
var v = g.index - 1 + h, g = g[0].slice(h), $ = g.length, y = v + $, b = m.slice(0, v + 1), w = m.slice(y + 1), E = [ d, 1 ];
b && E.push(b);
var k = new r(o, c ? n.tokenize(g, c) : g, p);
E.push(k), w && E.push(w), Array.prototype.splice.apply(i, E);
}
}
}
}
...
n.hooks.run("wrap", o);
var u = "";
for (var l in o.attributes) u += l + '="' + (o.attributes[l] || "") + '"';
...
//# sourceMappingURL=tutorial.258747a8aab739d1b709.js.map