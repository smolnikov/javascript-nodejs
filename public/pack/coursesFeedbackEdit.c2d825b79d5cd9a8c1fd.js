...
t.querySelector(".course-feedback__userpic-img").src = a(n.link, 86, 86), e.querySelector("i").style.backgroundImage = "url('" + a(n.link, 64, 64) + "')", 
...
var a = n(56).thumb, o = n(127), s = n(23);
r();
},
1: function(t, e, n) {
"use strict";
...
type: a
}) : (u = new c(), u.append(n), u.getBlob(a));
};
i.HTMLCanvasElement && !a.toBlob && (a.mozGetAsFile ? a.toBlob = function(t, e, n) {
t(n && a.toDataURL && u ? u(this.toDataURL(e, n)) : this.mozGetAsFile("blob", e));
} : a.toDataURL && u && (a.toBlob = function(t, e, n) {
...
//# sourceMappingURL=coursesFeedbackEdit.c2d825b79d5cd9a8c1fd.js.map