...
}), r = t.querySelector('[type="submit"]'), s = new i({
elem: r,
size: "small",
...
form: u
}), window.ga("send", "event", "newsletter", "subscribe", u), new o.Success(t.result.message, "slow"), 
e && e()) : (window.metrika.reachGoal("NEWSLETTER-SUBSCRIBE-FAIL", {
form: u
}), window.ga("send", "event", "newsletter", "subscribe-fail", u), new o.Error(t.result.message));
});
}
}
...
//# sourceMappingURL=nodejsScreencast.8a6fd5ede49c876e1dd1.js.map