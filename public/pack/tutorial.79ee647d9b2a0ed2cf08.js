...
function i() {
a(document, ".task__solution", "click", function(t) {
t.target.closest(".task").classList.toggle("task__answer_open");
}), a(document, ".task__answer-close", "click", function(t) {
t.target.closest(".task").classList.toggle("task__answer_open");
}), a(document, ".task__step-show", "click", function(t) {
t.target.closest(".task__step").classList.toggle("task__step_open");
});
}
function o() {
a(document, ".lessons-list__lesson_level_1 > .lessons-list__link", "click", function(t) {
...
var a = n(28), s = n(53), u = (n(29), n(25));
e.init = function() {
i(), o(), r(), a(document, '[data-action="tutorial-map"]', "click", function(t) {
new u(), t.preventDefault();
}), s.init(), window.ebookType && n.e(6, function() {
n(27).init();
});
}, e.TutorialMap = n(26);
},
...
e.remove(), document.body.insertAdjacentHTML("beforeEnd", '<div class="tutorial-map-overlay"></div>'), 
t.elem = document.body.lastChild, t.elem.innerHTML = n.result + '<button class="close-button tutorial-map-overlay__close"></button>', 
t.elem.addEventListener("click", function(e) {
...
t.elem.addEventListener("scroll", l), new u(t.elem.firstElementChild);
}), r.addEventListener("fail", function() {
return e.remove();
});
}
var i = n(29), o = n(28), a = n(11), s = n(54), u = n(26), l = n(22);
...
n(88), n(89), n(90), n(91), n(92), n(93), n(94), n(95), n(96), n(97), n(98), n(99), 
n(100), n(101), n(102), Prism.tokenTag = "code";
var a = n(80), s = n(81);
e.init = function() {
...
//# sourceMappingURL=tutorial.79ee647d9b2a0ed2cf08.js.map