...
return k.$resolved = !0, (S || h)(e), u.reject(e);
});
return j = j.then(function(e) {
var t = M(e);
return (E || h)(t, e.headers), t;
...
var h = t.noop, d = t.forEach, $ = t.extend, v = t.copy, m = t.isFunction;
return f.prototype = {
...
!RegExp("^\\d+$").test(e) && e && RegExp("(^|[^\\\\]):" + e + "(\\W|$)").test(l) && (p[e] = !0);
...
var $ = a(u || {}), v = [], m = [], g = {};
return R(u, h), u = m = g = null, function(r, o, a) {
function s() {
...
var h = e.defer(), m = h.promise, g = m.$$promises = {}, y = _({}, r), b = 1 + v.length / 3, w = !1;
if (V(o.$$failure)) return u(o.$$failure), m;
o.$$inheritedValues && i(y, p(o.$$inheritedValues, $)), _(g, o.$$promises), o.$$values ? (w = i(y, p(o.$$values, $)), 
...
var u, c = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, l = /([:]?)([\w\[\]-]+)|\{([\w\[\]-]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, f = "^", p = 0, h = this.segments = [], d = i ? i.params : {}, $ = this.params = i ? i.params.$$new() : new U.ParamSet(), v = [];
this.source = e;
...
var S = r.value !== n, C = p(r, S), A = $(r, E, S, C);
_(this, {
id: e,
type: t,
location: i,
...
if (y) return y;
if (t = g.to, n = g.toParams, o = g.options, v = p(t, o.relative), !V(v)) {
...
if (o.inherit && (n = u(h, n || {}, S.$current, v)), !v.params.$$validates(n)) return T;
...
M++, j = C[M];
if (x(t, n, c, f, P, o)) return m && (n["#"] = m), S.params = n, F(S.params, h), 
...
var L = S.transition = R.then(function() {
var r, i, a;
if (S.transition !== L) return A;
...
return m && (n["#"] = m), S.transition !== L ? A : (S.$current = t, S.current = t.self, 
S.params = n, F(S.params, h), S.transition = null, o.location && t.navigable && $.push(t.navigable.url, t.navigable.locals.globals.$stateParams, {
$$avoidResync: !0,
replace: "replace" === o.location
}), o.notify && e.$broadcast("$stateChangeSuccess", t.self, n, c.self, f), $.update(!0), 
S.current);
}, function(r) {
return S.transition !== L ? A : (S.transition = null, a = e.$broadcast("$stateChangeError", t.self, n, c.self, f, r), 
...
return V(i) ? S.$current !== i ? !1 : t ? c(i.params.$$values(t), h) : !0 : n;
...
var i = p(e, r.relative);
return V(i) ? V(S.$current.includes[i.name]) ? t ? c(i.params.$$values(t), h, a(t)) : !0 : !1 : n;
...
parent: function(e) {
if (V(e.parent) && e.parent) return p(e.parent);
var t = /^(.+)\.[^.]+$/.exec(e.name);
return t ? p(t[1]) : E;
},
data: function(e) {
...
var c = k(s.uiSref, e.current.name), l = null, f = O(a) || e.$current, p = "[object SVGAnimatedString]" === Object.prototype.toString.call(a.prop("href")) ? "xlink:href" : "href", h = null, d = "A" === a.prop("tagName").toUpperCase(), $ = "FORM" === a[0].nodeName, v = $ ? "action" : p, m = !0, g = {
relative: f,
inherit: !0
...
var b = function(r) {
if (r && (l = t.copy(r)), m) {
h = e.href(c.state, l, g);
var i = u[1] || u[0];
return i && i.$$addStateInfo(c.state, l), null === h ? (m = !1, !1) : (s.$set(v, h), 
n);
}
};
...
var p = s[u], h = a[p];
n && w(h) ? C(h) ? e[p] = new Date(h.valueOf()) : k(h) ? e[p] = RegExp(h) : h.nodeName ? e[p] = h.cloneNode(!0) : D(h) ? e[p] = h.clone() : (w(e[p]) || (e[p] = Ur(h) ? [] : {}), 
l(e[p], [ h ], !0)) : e[p] = h;
}
}
return c(e, r), e;
...
function I(e) {
return e && S(e.length) && Lr.test(Ir.call(e));
}
function D(e) {
...
for (r = 0; n > r; r++) if (!L(e[r], t[r])) return !1;
return !0;
}
}
return !1;
...
for (n = n || s.appendChild(t.createElement("div")), r = (hi.exec(e) || [ "", "" ])[1].toLowerCase(), 
...
var t;
if (E(e) && (e = Hr(e), t = !0), !(this instanceof Oe)) {
...
} else Ur(e) ? (s = e.length - 1, pe(e[s], "fn"), r = e.slice(0, s)) : pe(e, "fn", !0);
return r;
}
function et(e, t) {
function r(e) {
...
function i(e, t) {
if (he(e, "service"), (A(t) || Ur(t)) && (t = S.instantiate(t)), !t.$get) throw Ai("pget", "Provider '{0}' must define $get factory method.", e);
return x[e + v] = t;
}
function a(e, t) {
return function() {
...
b.put(e, !0);
try {
E(e) ? (t = jr(e), n = n.concat(h(t.requires)).concat(t._runBlocks), r(t._invokeQueue), 
r(t._configBlocks)) : A(e) ? n.push(S.invoke(e)) : Ur(e) ? n.push(S.invoke(e)) : pe(e, "module");
} catch (i) {
...
function c() {
w = u(), w = y(w) ? null : w, L(w, O) && (w = O), O = w;
}
function l() {
...
var a = 0, s = f({}, n, {
id: e
}), u = ve(), c = n && n.capacity || Number.MAX_VALUE, l = ve(), p = null, h = null;
return t[e] = {
put: function(e, t) {
if (!y(t)) {
...
var c = {}, l = "Directive", p = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/, h = /(([\w\-]+)(?:\:([^;]+))?;?)/, g = q("ngSrc,ngSrcset,src,srcset"), x = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, S = /^(on[a-z]+|formaction)$/;
this.directive = function k(t, n) {
return he(t, "directive"), E(t) ? (u(t), fe(n, "directiveFactory"), c.hasOwnProperty(t) || (c[t] = [], 
...
P.$$addScopeInfo(Mr(u), c)) : c = e, h = a.transcludeOnThisElement ? I(e, a.transclude, o) : !a.templateOnThisElement && o ? o : !o && t ? I(e, t) : null, 
a(s, c, u, i, h)) : s && s(e, u.childNodes, n, o);
}
for (var u, c, l, f, p, h, d, $ = [], v = 0; v < e.length; v++) u = new ae(), c = D(e[v], [], u, 0 === v ? i : n, o), 
l = c.length ? U(c, e[v], u, t, r, null, [], [], a) : null, l && l.scope && P.$$addScopeClass(u.$$element), 
p = l && l.terminal || !(f = e[v].childNodes) || !f.length ? null : N(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : t), 
...
var b = !1, x = !1;
c = m[g], l = c.name, $ = Hr(c.value), d = ft(l), (v = pe.test(d)) && (l = l.replace(Ii, "").substr(8).replace(/_(.)/g, function(e, t) {
...
if (a = e.className, w(a) && (a = a.animVal), E(a) && "" !== a) for (;o = h.exec(a); ) f = ft(o[2]), 
z(t, f, "C", r, i) && (n[f] = Hr(o[3])), a = a.substr(o.index + o[0].length);
break;
...
case Qr:
try {
o = p.exec(e.nodeValue), o && (f = ft(o[1]), z(t, f, "M", r, i) && (n[f] = Hr(o[2])));
} catch (C) {}
}
return t.sort(Y), t;
}
...
a[c.name] = p, R || e.data("$" + c.name + "Controller", p.instance);
}
return a;
}
...
var c, p, h, v, m, g, y, b, w;
r === i ? (y = o, g = o.$$element) : (g = Mr(i), y = new ae(g, o)), h = t, T ? p = t.$new(!0) : k && (h = t.$parent), 
s && (m = u, m.$$boundTransclude = s), O && (v = $(g, y, m, O, p, t)), T && (P.$$addScopeInfo(g, p, !0, !(j && (j === T || j === T.$$originalDirective))), 
P.$$addScopeClass(g, !0), p.$$isolateBindings = T.$$isolateBindings, b = oe(t, y, p, p.$$isolateBindings, T), 
b && p.$on("$destroy", b));
for (var x in v) {
var E = O[x], S = v[x], C = E.$$bindings.bindToController;
S.identifier && C && (w = oe(h, y, S.instance, C, E));
var A = S();
A !== S.instance && (S.instance = A, g.data("$" + E.name + "Controller", A), w && w(), 
w = oe(h, y, S.instance, C, E));
}
for (z = 0, W = l.length; W > z; z++) c = l[z], ie(c, c.isolateScope ? p : t, g, y, c.require && d(c.directiveName, c.require, g, v), m);
var V = t;
for (T && (T.template || null === T.templateUrl) && (V = p), e && e(V, i.childNodes, n, s), 
z = f.length - 1; z >= 0; z--) c = f[z], ie(c, c.isolateScope ? p : t, g, y, c.require && d(c.directiveName, c.require, g, v), m);
}
p = p || {};
for (var m, g, y, b, S, C = -Number.MAX_VALUE, k = p.newScopeDirective, O = p.controllerDirectives, T = p.newIsolateScopeDirective, j = p.templateDirective, V = p.nonTlbTranscludeDirective, N = !1, I = !1, R = p.hasElementTranscludeDirective, _ = o.$$element = Mr(r), U = c, L = a, z = 0, W = e.length; W > z; z++) {
m = e[z];
...
ne(s, B(y), r), L = P(y, a, C, U && U.name, {
nonTlbTranscludeDirective: V
})) : (y = Mr(Me(r)).contents(), _.empty(), L = P(y, a, n, n, {
needsNewScope: m.$$isolateScope || m.$$newScope
}))), m.template) if (I = !0, Z("template", j, m, _), j = m, S = A(m.template) ? m.template(_, o) : m.template, 
S = le(S), m.replace) {
if (U = m, y = Ee(S) ? [] : ht(Q(m.templateNamespace, Hr(S))), r = y[0], 1 != y.length || r.nodeType !== Zr) throw Ni("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", g, "");
ne(s, _, r);
var ee = {
$attr: {}
}, te = D(r, [], ee), se = e.splice(z + 1, e.length - (z + 1));
(T || k) && H(te, T, k), e = e.concat(te).concat(se), G(o, ee), W = e.length;
} else _.html(S);
if (m.templateUrl) I = !0, Z("template", j, m, _), j = m, m.replace && (U = m), 
v = J(e.splice(z, e.length - z), _, o, s, N && L, l, f, {
...
b = m.compile(_, o, L), A(b) ? h(null, b, Y, K) : b && h(b.pre, b.post, Y, K);
} catch (ue) {
i(ue, X(_));
}
...
v.transclude = L, p.hasElementTranscludeDirective = R, v;
}
function H(e, t, n) {
...
var d, y, b, x;
if (a = le(a), $.replace) {
if (b = Ee(a) ? [] : ht(Q(g, Hr(a))), d = b[0], 1 != b.length || d.nodeType !== Zr) throw Ni("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", $.name, m);
y = {
$attr: {}
}, ne(r, t, d);
var E = D(d, [], y);
w($.scope) && H(E, !0), e = E.concat(e), G(n, y);
} else d = h, t.html(a);
...
var o = i;
t.$$destroyed || (p ? p.push(t, n, r, o) : (l.transcludeOnThisElement && (o = I(t, l.transclude, i)), 
l(f, t, n, r, o)));
};
}
function Y(e, t) {
...
p.appendChild(a), Mr.hasData(a) && (Mr.data(r, Mr.data(a)), Tr ? (Fr = !0, Tr.cleanData([ a ])) : delete Mr.cache[a[Mr.expando]]);
for (var h = 1, d = n.length; d > h; h++) {
var $ = n[h];
Mr($).remove(), p.appendChild($), delete n[h];
}
n[0] = r, n.length = 1;
}
function re(e, t) {
...
var c, l, f, p, h = i.attrName, d = i.optional, v = i.mode;
switch (v) {
case "@":
d || Sr.call(t, h) || (n[o] = t[h] = void 0), t.$observe(h, function(e) {
E(e) && (n[o] = e);
}), t.$$observers[h].$$scope = e, E(t[h]) && (n[o] = r(t[h])(e));
break;
...
if (d && !t[h]) break;
l = s(t[h]), p = l.literal ? L : function(e, t) {
return e === t || e !== e && t !== t;
}, f = l.assign || function() {
throw c = n[o] = l(e), Ni("nonassign", "Expression '{0}' used with directive '{1}' is non-assignable!", t[h], a.name);
}, c = n[o] = l(e);
var m = function(t) {
...
m.$stateful = !0;
var g;
g = i.collection ? e.$watchCollection(t[h], m) : e.$watch(s(t[h], m), null, l.literal), 
u.push(g);
break;

case "&":
if (l = t.hasOwnProperty(h) ? s(t[h]) : $, l === $ && d) break;
n[o] = function(t) {
return l(e, t);
};
}
...
for (var f = "", p = Hr(t), h = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, d = /\s/.test(p) ? h : /(,)/, $ = p.split(d), v = Math.floor($.length / 2), m = 0; v > m; m++) {
var g = 2 * m;
f += T(Hr($[g]), !0), f += " " + Hr($[g + 1]);
}
var b = Hr($[2 * m]).split(/\s/);
f += T(Hr(b[0]), !0), 2 === b.length && (f += " " + Hr(b[1])), this[e] = t = f;
}
...
if (p = r.match(qi), !p) throw Di("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", r);
h = p[1], d = d || p[3], r = e.hasOwnProperty(h) ? e[h] : de(s.$scope, h, !0) || (t ? de(o, h, !0) : n), 
pe(r, h, !0);
}
if (u) {
...
n = e.indexOf(":"), t(Er(Hr(e.substr(0, n))), Hr(e.substr(n + 1)));
...
function a(e) {
var t = f({}, e);
return t.data = Ct(e.data, e.headers, e.status, c.transformResponse), At(e.status) ? t : p.reject(t);
}
function s(e, t) {
var n, r = {};
...
c.headers = u(t), c.method = Cr(c.method), c.paramSerializer = E(c.paramSerializer) ? h.get(c.paramSerializer) : c.paramSerializer;
var l = function(t) {
...
return pe(e, "fn"), $.then(function(t) {
e(t.data, t.status, t.headers, c);
}), $;
}, $.error = function(e) {
return pe(e, "fn"), $.then(null, function(t) {
e(t.data, t.status, t.headers, c);
}), $;
...
h && (At(e) ? h.put(S, [ e, n, Et(r), i ]) : h.remove(S)), t ? l.$applyAsync(o) : (o(), 
l.$$phase || l.$apply());
}
function a(e, t, n, i) {
...
h && ($ = h.get(S), b($) ? N($) ? $.then(c, c) : Ur($) ? a($[1], $[0], U($[2]), $[3]) : a($, 200, {}, "OK") : h.put(S, m)), 
y($)) {
...
if (p && S.length > 1 && Wi.throwNoconcat(o), !u || w.length) {
var k = function(e) {
...
var c = e.length, l = t.length, p = RegExp(e.replace(/./g, o), "g"), h = RegExp(t.replace(/./g, o), "g");
...
function i(i, a, s, u) {
var c = arguments.length > 4, l = c ? B(arguments, 4) : [], f = t.setInterval, p = t.clearInterval, h = 0, d = b(u) && !u, $ = (d ? r : n).defer(), v = $.promise;
return s = b(s) ? s : 0, v.then(null, null, c ? function() {
i.apply(null, l);
} : i), v.$$intervalId = f(function() {
$.notify(h++), s > 0 && h >= s && ($.resolve(h), p(v.$$intervalId), delete o[v.$$intervalId]), 
d || e.$apply();
}, a), o[v.$$intervalId] = $, v;
}
var o = {};
...
function Nt(e, t) {
var n = On(e);
t.$$protocol = n.protocol, t.$$host = n.hostname, t.$$port = h(n.port) || Ji[n.protocol] || null;
}
function It(e, t) {
var n = "/" !== e.charAt(0);
n && (e = "/" + e);
...
if (t.enabled) {
if (!h && t.requireBase) throw Yi("nobase", "$location in HTML5 mode requires a <base> tag to be present!");
p = Ft(d) + (h || "/"), f = o.history ? Ut : Ht;
} else p = qt(d), f = Lt;
var $ = _t(p);
...
var t = u(e);
return i(t, c) || (s = o(e, n, n, [ t ]), c = t && pn(t)), s;
}, t, r, a);
}
...
var g = o ? h : p, y = new ro(g), b = new oo(y, r, g);
...
if (!A(e)) throw h("norslvr", "Expected resolverFn, got '{0}'", e);
...
function h(e) {
9 === Or && (e.$$childHead && h(e.$$childHead), e.$$nextSibling && h(e.$$nextSibling)), 
...
n.$stateful = !0;
var o, a, s, u = this, c = t.length > 1, f = 0, p = l(e, n), h = [], d = {}, $ = !0, v = 0;
return this.$watch(p, r);
},
$digest: function() {
var e, r, i, o, u, l, p, h, d, $, g = t, y = this, b = [];
...
if (e = o[u]) if ((r = e.get(h)) === (i = e.last) || (e.eq ? L(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
if (e === a) {
l = !1;
break e;
}
} else l = !0, a = e, e.last = e.eq ? F(r, null) : r, e.fn(r, i === x ? r : i, h), 
...
for (var a, s, u, l = H([ o ], arguments, 1); r = i; ) {
...
var n, r, i = {}, o = h((/android (\d+)/.exec(Er((e.navigator || {}).userAgent)) || [])[1]), a = /Boxee/i.test((e.navigator || {}).userAgent), s = t[0] || {}, u = /^(Moz|webkit|ms)(?=[A-Z])/, c = s.body && s.body.style, l = !1, f = !1;
if (c) {
...
function In(e, t, n) {
var r, i = w(e) && "$" in e;
return t === !0 ? t = L : A(t) || (t = function(e, t) {
...
var p = (s.split(fo)[1] || "").length;
y(i) && (i = Math.min(Math.max(t.minFrac, p), t.maxFrac)), e = +("" + Math.round(+("" + e + "e" + i)) + "e" + -i);
var h = ("" + e).split(fo), d = h[0];
h = h[1] || "";
...
var a, s, u = "", c = [];
if (r = r || "mediumDate", r = e.DATETIME_FORMATS[r] || r, E(n) && (n = $o.test(n) ? h(n) : t(n)), 
S(n) && (n = new Date(n)), !C(n) || !isFinite(n.getTime())) return n;
for (;r; ) s = ho.exec(r), s ? (c = H(c, s, 1), r = c.pop()) : (c.push(r), r = null);
var l = n.getTimezoneOffset();
return i && (l = Y(i, n.getTimezoneOffset()), n = K(n, i, !0)), o(c, function(t) {
a = po[t], u += a ? a(n, e.DATETIME_FORMATS, l) : t.replace(/(^'|'$)/g, "").replace(/''/g, "'");
}), u;
};
}
function Xn() {
...
Ur(e) || E(e) ? (n = !n || isNaN(n) ? 0 : h(n), n = 0 > n ? Math.max(0, e.length + n) : n, 
...
return p(e) ? (d = e, d && $ && (d = K(d, $, !0)), f("date")(e, i, $)) : (d = null, 
"");
}), b(s.min) || s.ngMin) {
var v;
...
var Fr, Ur = Array.isArray, Lr = /^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array\]$/, Hr = function(e) {
return E(e) ? e.trim() : e;
}, Br = function(e) {
...
}, li = r("jqLite"), fi = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, pi = /<|&#?\w+;/, hi = /<([\w:-]+)/, di = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, $i = {
...
r.computed = !1, r.name = e.name), Jt(e.name), p.if_("inputs" === p.stage || p.not(p.getHasOwnProperty("l", e.name)), function() {
...
}, t && p.lazyAssign(t, p.nonComputedMember("l", e.name))), (p.state.expensiveChecks || fn(e.name)) && p.addEnsureSafeObject(t), 
i(t);
break;
...
e.computed ? (c = p.nextId(), p.recurse(e.property, c), p.getStringValue(c), p.addEnsureSafeMemberName(c), 
...
r.name = c)) : (Jt(e.property.name), a && 1 !== a && p.if_(p.not(p.nonComputedMember(u, e.property.name)), p.lazyAssign(p.nonComputedMember(u, e.property.name), "{}")), 
f = p.nonComputedMember(u, e.property.name), (p.state.expensiveChecks || fn(e.property.name)) && (f = p.ensureSafeObject(f)), 
...
l.push(p.escape(e.key.type === io.Identifier ? e.key.name : "" + e.key.value) + ":" + t);
});
}), f = "{" + l.join(",") + "}", this.assign(t, f), i(f);
break;
...
u.$$parentForm.$removeControl(u), p(e, n), f(u, bo);
});
}
};
}
...
}), Lo = mr("", !0), Ho = mr("Odd", 0), Bo = mr("Even", 1), zo = tr({
compile: function(e, t) {
...
var a = t.attr(r.$attr.ngList) || ", ", s = "false" !== r.ngTrim, u = s ? Hr(a) : a, c = function(e) {
if (!y(e)) {
var t = [];
...
} else if (!h.assign) throw sa("nonassign", "Expression '{0}' is non-assignable. Element: {1}", r.ngModel, X(i));
...
this.$options.updateOn = Hr(this.$options.updateOn.replace(la, function() {
...
terminal: !0,
priority: 1e3
}), ha = r("ngOptions"), da = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/, $a = [ "$compile", "$parse", function(e, r) {
function a(e, t, n) {
...
var s = e.match(da);
if (!s) throw ha("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", e, X(t));
...
if (x && r.prepend(v), n = h(n), S.items.forEach(function(e) {
var i, o, a;
...
}), p(n), $.$render(), !$.$isEmpty(e)) {
var i = m.readValue();
(C.trackBy ? L(e, i) : e === i) || ($.$setViewValue(i), $.$render());
}
}
var $ = s[1];
if ($) {
...
var l, f = u.count, p = u.$attr.when && s.attr(u.$attr.when), h = u.offset || 0, d = a.$eval(p) || {}, v = {}, m = t.startSymbol(), g = t.endSymbol(), b = m + f + "-" + h + g, w = Rr.noop;
o(u, function(e, t) {
var n = i.exec(t);
if (n) {
var r = (n[1] ? "-" : "") + Er(n[2]);
...
var p, m, y, x, A, k, O, M, T, j, P, V, N = t[0], I = ve();
if (g && (e[g] = r), i(r)) T = r, M = E || S; else {
M = E || C, T = [];
for (var D in r) Sr.call(r, D) && "$" !== D.charAt(0) && T.push(D);
}
for (x = T.length, P = Array(x), p = 0; x > p; p++) if (A = r === T ? p : T[p], 
k = r[A], O = M(A, k, p), v[O]) j = v[O], delete v[O], I[O] = j, P[p] = j; else {
...
for (var q in v) {
if (j = v[q], V = $e(j.clone), a.leave(V), V[0].parentNode) for (p = 0, m = V.length; m > p; p++) V[p][s] = !0;
j.scope.$destroy();
}
for (p = 0; x > p; p++) if (A = r === T ? p : T[p], k = r[A], j = P[p], j.scope) {
y = N;
do y = y.nextSibling; while (y && y[s]);
l(j) != y && a.move($e(j.clone), null, Mr(N)), N = f(j), c(j.scope, p, b, k, w, A, x);
} else $(function(e, t) {
j.scope = t;
var n = d.cloneNode(!1);
e[e.length++] = n, a.enter(e, null, Mr(N)), N = n, j.clone = e, I[j.id] = j, c(j.scope, p, b, k, w, A, x);
});
v = I;
});
};
...
var s, u = NaN;
e.$watch(function() {
u !== i.$viewValue || L(s, i.$viewValue) || (s = U(i.$viewValue), i.$render()), 
u = i.$viewValue;
}), i.$isEmpty = function(e) {
return !e || 0 === e.length;
};
...
//# sourceMappingURL=angular.ab47d31a5bdad3ba4b57.js.map