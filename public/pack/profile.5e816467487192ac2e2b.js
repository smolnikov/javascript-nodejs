...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('profile').directive('orderParticipants', function (promiseTracker, $http, $timeout) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('profile').directive('orderContact', function (promiseTracker, $http, $timeout) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function ($scope, $state, $timeout, $http, me, promiseTracker) {
	  ...
	  $scope.tabs = tabs.map(function (stateName) {
...
//# sourceMappingURL=profile.5e816467487192ac2e2b.js.map