...
if (n--, n >= 0) {
var i = t[n].firstElementChild && t[n].firstElementChild.getAttribute("href"), s = document.querySelector('.sidebar__navigation-link a[href="' + i + '"]');
i && s && s.classList.add("sidebar__navigation-link_active");
}
}
...
if (l == n) for (var r in a) a.hasOwnProperty(r) && (o[r] = a[r]);
o[l] = s[l];
}
...
for (var a, i = document.querySelectorAll('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'), s = 0; a = i[s++]; ) t.highlightElement(a, e === !0, n);
},
highlightElement: function(a, i, s) {
for (var r, o, l = a; l && !e.test(l.className); ) l = l.parentNode;
l && (r = (l.className.match(e) || [ , "" ])[1], o = t.languages[r]), a.className = a.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r, 
l = a.parentNode, /pre/i.test(l.nodeName) && (l.className = l.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r);
...
s && s.call(u.element), t.hooks.run("after-highlight", u), t.hooks.run("complete", u);
...
u.element.innerHTML = u.highlightedCode, s && s.call(a), t.hooks.run("after-highlight", u), 
...
S.push(A), y && S.push(y), Array.prototype.splice.apply(s, S);
}
}
}
}
...
run: function(e, n) {
var a = t.hooks.all[e];
if (a && a.length) for (var i, s = 0; i = a[s++]; ) i(n);
}
}
...
var a = JSON.parse(e.data), i = a.language, s = a.code, r = a.immediateClose;
n.postMessage(t.highlight(s, t.languages[i], i)), r && n.close();
}, !1), n.Prism) : n.Prism;
...
var i = new XMLHttpRequest(), r = e.method || "GET", o = e.body, l = e.url;
i.open(r, l, e.sync ? !1 : !0), i.method = r;
var c = s();
...
var s = i.responseText, r = i.getResponseHeader("Content-Type");
...
if (!a.length) return void new r.Info("Выберите рассылки из списка.");
var c = {
...
form: h
}), window.ga("send", "event", "newsletter", "subscribe", h), new r.Success(n.result.message, "slow"), 
e.elements.email.value = "", t && t()) : (window.metrika.reachGoal("NEWSLETTER-SUBSCRIBE-FAIL", {
form: h
}), window.ga("send", "event", "newsletter", "subscribe-fail", h), new r.Error(n.result.message));
});
}
}
var i = n(150), s = n(155), r = n(147);
...
var s = n.getBoundingClientRect().left, r = a(n);
n.parentNode.insertBefore(r, n), i.appendChild(n), n.classList.add("sticky"), n.style.position = "fixed", 
n.style.top = 0, n.style.left = s + "px", n.style.zIndex = 101, n.style.background = "white", 
n.style.margin = 0, n.style.width = r.offsetWidth + "px", n.placeholder = r;
...
var a = t[n];
new r(a), a.setAttribute("data-prism-done", "1");
}
}
function i(e) {
...
}, 2e3), e.hasAttribute("data-demo-height") || r.iframe(t), w && e.hasAttribute("data-autorun") || o(v) || v.scrollIntoView(!1);
} else {
...
s.name = "code", s.value = u(m), i.appendChild(s), t.parentNode.insertBefore(i, t.nextSibling), 
i.submit(), i.remove(), w && e.hasAttribute("data-autorun") || (t.onload = function() {
e.hasAttribute("data-demo-height") || r.iframe(t), o(v) || v.scrollIntoView(!1);
});
}
}
function a() {
...
function u() {
var e = m.toLowerCase(), t = e.match("<body>"), n = e.match("</body>"), a = e.match("<html>"), i = e.match("</html>"), s = e.match(/^\s*<!doctype/);
if (s) return m;
var r = m;
...
Prism.highlightElement(h), l(p), i(p, e.getAttribute("data-highlight-block")), s(p, e.getAttribute("data-highlight-inline"));
var g = p.classList.contains("language-javascript"), f = p.classList.contains("language-markup"), E = +e.getAttribute("data-trusted"), b = +e.getAttribute("data-no-strict");
!b && g && (m = "'use strict';\n" + m);
var T, v, w = !0;
if (g || f) {
...
n = n.split("-");
var s = +n[0], r = +n[1] || s, o = '<code class="block-highlight" data-start="' + s + '" data-end="' + r + '">' + Array(s + 1).join("\n") + '<code class="mask">' + Array(r - s + 2).join("\n") + "</code></code>";
...
var i = t[a].split(":"), s = +i[0], r = i[1].split("-"), o = +r[0], l = +r[1], c = '<code class="inline-highlight">' + Array(s + 1).join("\n") + Array(o + 1).join(" ") + '<code class="mask">' + Array(l - o + 1).join(" ") + "</code></code>";
n.insertAdjacentHTML("afterBegin", c);
}
}
var r = n(197), o = n(239), l = n(240);
e.exports = a;
},
239: function(e, t) {
"use strict";
...
var s = n[i], r = a[i];
s == e.delegateTarget ? (t = i, r.classList.add("code-tabs__section_current"), s.classList.add("code-tabs__switch_current")) : (r.classList.remove("code-tabs__section_current"), 
...
Prism.highlightElement(n), s(t), e.highlighted = !0;
}
...
var i = n(155), s = n(148), r = n(153), o = n(150), l = n(243), c = n(185);
s.delegateMixin(a.prototype), a.prototype.remove = function() {
...
this.elem.querySelectorAll(".tutorial-map__item")), s = 0; s < a.length; s++) {
var r = a[s], o = r.querySelectorAll(".tutorial-map__sub-item"), l = Array.prototype.reduce.call(o, function(e, a) {
var i = !1;
if (n) {
var s = a.querySelectorAll(".tutorial-map__sub-sub-item");
i = Array.prototype.reduce.call(s, function(e, n) {
var a = t(n);
return n.hidden = !a, e || a;
}, !1);
}
var r = i || t(a);
return a.hidden = !r, e || r;
}, !1);
r.hidden = !(l || t(r));
}
}, a.prototype.throttleFilter = s(a.prototype.filter, 200), r.delegateMixin(a.prototype), 
e.exports = a;
}
});
//# sourceMappingURL=tutorial.718527394608b9fb1793.js.map