...
/***/ function(module, exports, __webpack_require__) {
	...
	block: function(){
	jade_mixins["e"].call({
	attributes: {"id": "register-password","type": "password","name": "password","required": true,"minlength": "4","class": "control"}
	}, 'input');
	},
	attributes: {"class": "text-input __input"}
	}, 'span');
	...
	attributes: {"type": "submit","class": "button _action submit"}
	}, 'button');
	jade_mixins["e"].call({
	block: function(){
	buf.push("Отмена");
...
/***/ function(module, exports, __webpack_require__) {
	...
	attributes: {"type": "submit","class": "button _action __submit"}
	}, 'button');
	},
	attributes: {"class": "line"}
	});
...
//# sourceMappingURL=authClient-7.5e816467487192ac2e2b.js.map