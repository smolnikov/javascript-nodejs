...
}, 2e3), e.hasAttribute("data-demo-height") || a.iframe(t), k && e.hasAttribute("data-autorun") || s(m) || m.scrollIntoView(!1);
} else {
...
n.submit(), n.remove(), k && e.hasAttribute("data-autorun") || (t.onload = function() {
e.hasAttribute("data-demo-height") || a.iframe(t), s(m) || m.scrollIntoView(!1);
});
}
}
function i() {
...
Prism.highlightElement(u), l(_), n(_, e.getAttribute("data-highlight-block")), r(_, e.getAttribute("data-highlight-inline"));
var b, m, g = _.classList.contains("language-javascript"), h = _.classList.contains("language-markup"), x = +e.getAttribute("data-trusted"), k = !0;
if (g || h) {
...
//# sourceMappingURL=tutorial.94a1d31af79df4d9c87d.js.map