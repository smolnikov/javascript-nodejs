...
function n(t, n) {
var s = e("fail", n);
s.reason = t, i.dispatchEvent(s);
}
function s(t, n) {
var s = e("success", n);
s.result = t, i.dispatchEvent(s);
}
var i = new XMLHttpRequest(), o = t.method || "GET", r = t.body, l = t.url;
i.open(o, l, t.sync ? !1 : !0), i.method = o;
var c = a();
c && !t.skipCsrf && i.setRequestHeader("X-XSRF-TOKEN", c), "[object Object]" == {}.toString.call(r) && (i.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), 
r = JSON.stringify(r)), t.noDocumentEvents || (i.addEventListener("loadstart", function(t) {
...
if (!r.class && i && !a) throw Error("Block without class: " + i);
if (r.class) {
var l = r.class;
...
a ? l[0] = s[s.length - 1] + t.element + l[0] : s[s.length] = c;
var f = (a ? s[s.length - 1] + t.element : "") + c;
-1 === l.indexOf(f) && (l[l.length] = f);
for (var d = 0; d < l.length; d++) {
var h = l[d];
h.match(RegExp("^(?!" + t.element + ")" + t.modifier)) ? l[d] = f + h : h.match(RegExp("^" + t.element)) && (s[s.length - 2] ? l[d] = s[s.length - 2] + h : l[d] = s[s.length - 1] + h), 
...
var i = t, a = e, o = n;
r = c = l = void 0, s = !1;
var r = Object.getOwnPropertyDescriptor(i, a);
if (void 0 !== r) {
...
for (var s = [], a = 0; a < t.length; a++) n && n[a] ? s.push(e.escape(i([ t[a] ]))) : s.push(i(t[a]));
var o = i(s);
...
var r = a[o], l = t[r];
"class" == r ? (l = i(l)) && s.push(" " + r + '="' + l + '"') : s.push(e.attr(r, l, !1, n));
}
return s.join("");
}, e.escape = function(t) {
var e = (t + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
return e === "" + t ? t : e;
}, e.rethrow = function o(t, e, s, i) {
if (!(t instanceof Error)) throw t;
if (!("undefined" == typeof window && e || i)) throw t.message += " on line " + s, 
t;
try {
...
}(), a = n(28), o = n(27), r = n(53), l = n(113), c = n(114), u = n(115), f = n(49), d = function() {
function t(e) {
...
if (201 == this.status) return i.elem.innerHTML = f(l, this.options), void i.showFormMessage({
...
s.addEventListener("success", function(t) {
200 == this.status ? (i.elem.innerHTML = f(l, this.options), i.showFormMessage({
html: t.result,
type: "success"
...
s.addEventListener("success", function(t) {
return 401 == s.status ? (i(), void e.onAuthFailure(t.result.message)) : void (e.options.callback ? (i(), 
...
var e = 800, n = 600, s = (window.outerHeight - n) / 2, i = (window.outerWidth - e) / 2;
window.authForm = this, this.authPopup = window.open(t, "authForm", "width=" + e + ",height=" + n + ",scrollbars=0,top=" + s + ",left=" + i);
}
}, {
key: "onAuthSuccess",
value: function(t) {
...
//# sourceMappingURL=authClient-2.8a6fd5ede49c876e1dd1.js.map