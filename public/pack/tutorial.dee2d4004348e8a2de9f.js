...
"use strict";
function init() {
initTaskButtons(), initFolderList(), initSidebarHighlight(), delegate(document, '[data-action="tutorial-map"]', "click", function(e) {
...
e.mapElem.addEventListener("scroll", c), new u(e.mapElem.firstElementChild);
}), r.addEventListener("fail", function() {
return t.remove();
});
}
var i = n(28), a = n(27), o = n(10), s = n(53), u = n(25), c = n(21);
...
r.open(), r.write(l(d)), r.close(), "epub" == window.ebookType && setTimeout(function() {
[].forEach.call(r.querySelectorAll("script"), function(e) {
e.remove();
});
}, 2e3), e.hasAttribute("data-demo-height") || o.iframe(t), b && e.hasAttribute("data-autorun") || s(v) || v.scrollIntoView(!1);
} else {
...
a.name = "code", a.value = l(d), i.appendChild(a), t.parentNode.insertBefore(i, t.nextSibling), 
i.submit(), i.remove(), b && e.hasAttribute("data-autorun") || (t.onload = function() {
e.hasAttribute("data-demo-height") || o.iframe(t), s(v) || v.scrollIntoView(!1);
});
}
}
function r() {
...
var m, v, g = p.classList.contains("language-javascript"), $ = p.classList.contains("language-markup"), y = +e.getAttribute("data-trusted"), b = !0;
if (g || $) {
...
if (u && (o = (u.className.match(e) || [ , "" ])[1], s = t.languages[o]), r.className = r.className.replace(e, "").replace(/\s+/g, " ") + " language-" + o, 
...
l.highlightedCode = n.stringify(JSON.parse(e.data), o), t.hooks.run("before-insert", l), 
l.element.innerHTML = l.highlightedCode, a && a.call(l.element), t.hooks.run("after-highlight", l);
}, f.postMessage(JSON.stringify({
language: l.language,
code: l.code
}));
} else l.highlightedCode = t.highlight(l.code, l.grammar, l.language), t.hooks.run("before-insert", l), 
l.element.innerHTML = l.highlightedCode, a && a.call(r), t.hooks.run("after-highlight", l);
}
}
},
...
var c = s[u], l = c.inside, f = !!c.lookbehind, p = 0, h = c.alias;
c = c.pattern || c;
...
b && E.push(b);
var x = new r(o, l ? t.tokenize(v, l) : v, h);
...
//# sourceMappingURL=tutorial.dee2d4004348e8a2de9f.js.map