...
function n() {
var e;
if (v && t.hasAttribute("data-refresh") && (v.remove(), v = null), v || (v = t.querySelector(".code-result")), 
v) e = v.querySelector("iframe"); else {
...
v.appendChild(e), t.appendChild(v);
}
if (b) {
...
}, 2e3), t.hasAttribute("data-demo-height") || o.iframe(e), $ && t.hasAttribute("data-autorun") || s(v) || v.scrollIntoView(!1);
} else {
...
t.hasAttribute("data-demo-height") || o.iframe(e), s(v) || v.scrollIntoView(!1);
});
}
}
function r() {
...
var m, v, g = h.classList.contains("language-javascript"), y = h.classList.contains("language-markup"), b = +t.getAttribute("data-trusted"), $ = !0;
if (g || y) {
...
//# sourceMappingURL=quiz.dee2d4004348e8a2de9f.js.map