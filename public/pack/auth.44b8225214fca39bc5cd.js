...
for (var r = !0; r; ) {
var i = t, o = e, a = n;
s = u = c = void 0, r = !1, null === i && (i = Function.prototype);
...
var a = 3, s = i.split("\n"), c = Math.max(r - a, 0), u = Math.min(s.length, r + a), a = s.slice(c, u).map(function(t, e) {
var n = e + c + 1;
return (n == r ? "  > " : "    ") + n + "| " + t;
}).join("\n");
...
attributes: {
"data-form": "login",
"class": (e = [ !0 ], r.joinClasses([ [ "login-form", o ? "_modal" : "_inline" ] ].map(r.joinClasses).map(function(t, n) {
return e[n] ? r.escape(t) : t;
})))
}
});
}.call(this, "bem" in o ? o.bem : "undefined" != typeof bem ? bem : void 0, "inModal" in o ? o.inModal : "undefined" != typeof inModal ? inModal : void 0), 
n.join("");
};
},
114: function(t, e, n) {
...
}(), o = n(28), a = n(27), s = n(53), c = n(113), u = n(114), l = n(115), h = n(49), f = function() {
function t(e) {
...
key: "render",
value: function() {
this.elem = document.createElement("div"), this.elem.innerHTML = h(c, this.options), 
...
if (201 == this.status) return i.elem.innerHTML = h(c, this.options), void i.showFormMessage({
...
r.addEventListener("success", function(t) {
200 == this.status ? (i.elem.innerHTML = h(c, this.options), i.showFormMessage({
html: t.result,
type: "success"
...
//# sourceMappingURL=auth.44b8225214fca39bc5cd.js.map